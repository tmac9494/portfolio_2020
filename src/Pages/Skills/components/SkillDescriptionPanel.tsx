...
import { ScrollShadows, AnimationParent } from "../../../components/General";
import { ReactComponent as CloseSvg } from "../../../assets/icons/close.svg";
import { SkillBar } from "./SkillBar";
import { ReactComponent as StarSvg } from "../../../assets/icons/star.svg";
import { IconAccordion } from "../../../components/General/IconAccordion";
import { SkillKeyTagsPanel } from "./SkillKeyTagsPanel";

export const SkillDescriptionPanel = () => {
  const { skillDescription, skillDescriptionVisibility, origin } =
    useSkillContext();
  ...
  return (
    ...
    >
      <div className="close-btn">
        <button className="normalize-btn" onClick={closeSkillDescription}>
          <CloseSvg className="close-icon" />
        </button>
      </div>

      <SkillKeyTagsPanel extensiveExperience={isSpecialty} isLove={isLove} />
      ...
      <div id="skill_description_intro">
        <div className="image-container">
          ...
          />
          <SpecialtyFlare key={skillDescription} isSpecial={isSpecialty} />
        </div>
      ...
      >
        ...
        <div className="accolades">
          <ul>
            <li key="experience">
              {skillInfo?.yearsOfExp || 0} years of experience.
            </li>
...
export const SpecialtyFlareItem = ({
  id,
  className,
  delay,
}: {
