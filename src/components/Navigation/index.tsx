...
const Navigation: React.FC = () => {
  return (
    <div id="navigation">
      <NavLink className={"nav-btn home-nav-btn"} to="/">
        <svg
          id="home_icon"
      ...
      <NavLink className={"nav-btn work-nav-btn"} to="/work">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="512"
          height="512"
      ...
      <NavLink className={"nav-btn skills-nav-btn"} to="/skills">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="512"
          height="512"
      ...
      <NavLink className={"nav-btn resume-nav-btn"} to="/resume">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="512"
          height="512"
